export default class Giana {
    ...
    draw(ctx) {
        ...
        if (this.velocityX < 0) {
            ...
            ctx.scale(-1, 1);
            // Draw the full image
            ctx.drawImage(sprite, 0, 0, sprite.width, sprite.height, 0, 0, this.width, this.height);
        } else {
            // Draw the full image
            ctx.drawImage(sprite, 0, 0, sprite.width, sprite.height, this.x, this.y, this.width, this.height);
        }
        ctx.restore();
    }
}
